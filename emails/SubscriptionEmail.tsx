...
export const SubscriptionEmail = ({
  ...
  return (
    <BaseLayout previewText='Welcome to Reelty – Your Subscription is Live!'>
      <Text style={theme.typography.h1}>You're In! Welcome to Reelty</Text>
      ...
      <Section style={{ margin: `${theme.spacing.xl} 0` }}>
        <a
          href='https://www.reelty.io/dashboard'
          style={{
      ...
      <Text style={theme.typography.body}>Need anything? We're here.</Text>
