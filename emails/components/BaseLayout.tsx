    ...
    <Html>
      ...
      <Body style={{
        ...
        <Container style={theme.containers.main}>
          ...
          <Section style={theme.containers.section}>
            {children}
          </Section>
          
          <Text style={{ ...theme.typography.small, fontSize: '14px', color: '#666666', textAlign: 'center' }}>
            © 2025 Zero21 Media LLC dba Reelty. All rights reserved.
          </Text>
          
          <Text style={{ ...theme.typography.small, fontSize: '14px', color: '#666666', textAlign: 'center' }}>
            This is a transactional email from Reelty. You can manage your email preferences in your account settings.
          </Text>
