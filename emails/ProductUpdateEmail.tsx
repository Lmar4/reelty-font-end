...
const ProductUpdateEmail = ({
  ...
  return (
    <BaseLayout previewText={`🚀 New Feature Alert: ${updateTitle}`}>
      <Text style={theme.typography.h1}>New Reelty Feature!</Text>

      <Text style={theme.typography.body}>
        We just rolled out {updateTitle}, designed to make your workflow even
        better.
      </Text>

      <Text style={theme.typography.body}>{updateDescription}</Text>
