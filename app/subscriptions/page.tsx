...
export default function Subscriptions() {
  ...
  const formatNextBillingDate = () => {
    ...
    return new Date(userData.subscriptionPeriodEnd).toLocaleDateString("en-US", {
      year: "numeric",
      month: "long",
      day: "numeric",
    });
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      ...
                      <p className="text-lg">
                        ...
                        {calculatePriceDifference(selectedTier) > 0 ? "increase" : "decrease"}
                      </p>
                    </div>
                    ...
                    <p className="text-sm text-gray-500">
                      Your subscription will be updated immediately, and the new pricing will be
