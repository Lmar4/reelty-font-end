...
export type TemplateOutput = RouterOutput["admin"]["getTemplates"][number];
export type AssetOutput = RouterOutput["admin"]["getAssets"][number];
export type TempUploadOutput = NonNullable<RouterOutput["property"]["getTempUpload"]>;

// Additional type exports
export type FeatureUsageOutput = RouterOutput["admin"]["getFeatureUsage"];
export type SystemStatsOutput = RouterOutput["admin"]["getSystemStats"];
