  ...
  return (
    ...
    >
      <div className='bg-white rounded-lg max-w-[900px] w-[calc(100%-2rem)] max-h-[80vh] sm:max-h-[90vh] relative mx-auto flex flex-col overflow-hidden'>
          ...
          <div className='p-4'>
            <div className='flex flex-col gap-3 mb-4'>
              ...
              <div>
                ...
                <div className='flex items-center justify-between text-[15px] font-medium mb-2 text-black'>
        ...
        {/* Action Buttons */}
        <div className='bg-white pb-3 px-3 sm:px-4 sm:pb-4 flex gap-3'>
          <button
            onClick={onClose}
            className='flex-1 border border-gray-200 text-black rounded-lg h-10 sm:h-12 text-[16px] font-semibold hover:bg-gray-50'
          >
            Cancel
          </button>
          <button className='flex-1 bg-black text-white rounded-lg h-10 sm:h-12 text-[16px] font-semibold flex items-center justify-center gap-2'>
            <svg
              width='16'
              height='16'
              viewBox='0 0 24 24'
